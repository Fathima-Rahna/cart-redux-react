...
const Home = () => {
  ...
  return (
   ...
   <div className='container' style={{marginTop:'100px'}}>
    {
      loading?<div className='mt-5 text-center fw-bolder'>    <Spinner annimation="border"
      variant='danger' className='me-2' /> Loading---</div>
   :
   <Row>
   ...
   visibleCards?.map(product=>(
    ...
    <div className='fw-bolder text-primary text-center mt-5 mb-5 fs-4'>Products are not to display!!!</div>
