        ...
        {wishlist.length > 0 ? 
         ...
         : 
          <div style={{ height: '70vh' }} className='w-100 d-flex justify-content-center align-items-center flex-column'>
            <img style={{ width: '700px' }} src='https://static.vecteezy.com/system/resources/previews/008/515/488/large_2x/empty-cart-flat-illustration-concept-vector.jpg' alt="Empty Wishlist" />
